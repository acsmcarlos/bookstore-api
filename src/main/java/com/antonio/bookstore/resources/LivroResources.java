...
import com.antonio.bookstore.dto.LivroDTO;
import com.antonio.bookstore.service.LivroService;
...
public class LivroResources {
	...
	@PutMapping(value = "/{id}") //ATUALIZAR LIVRO
	...
	@PatchMapping(value = "/{id}") //ATUALIZAR LIVRO
